...
async def on_message(message):
    ...
    if message.content.startswith("=commands"):
        ...
        embed.add_field(name="English", value="=calc {symbol} num1 num2 =followme {text} =join =disconnect", inline=False)
        embed.add_field(name="한국어", value="=계산 {수학부호} 숫자1 숫자2  =따라하기 {텍스트} =참가 =연결끊기", inline=False)
